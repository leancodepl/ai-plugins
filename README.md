...
- [`a11y-vo-log`](plugins/a11y-vo-log/) - VoiceOver AppleScript control, macOS Automation permission, and (optional) Karabiner gesture rules
...
- [`a11y-vo-log`](plugins/a11y-vo-log/) - capture a text transcript of everything VoiceOver speaks (and each keyboard nav gesture) during a manual screen-reader session on macOS, then diagnose it via `/a11y-vo-log`
